 ...
 ***********************
 */
void QuadController::calculatePid( double dt ){
  ...
  double temp = *this->rollPid->measured;
  *this->rollPid->measured  -= (*this->pitchPid->measured)*sin( (*this->yawPid->measured)*dt );
  *this->pitchPid->measured += temp*sin( (*this->yawPid->measured)*dt );
...
void QuadController::calculate( double dt ) {
  ...
  //Serial.println(this->pidOn);
  if( this->pidOn ){ 
    this->calculatePid( dt );
  }
