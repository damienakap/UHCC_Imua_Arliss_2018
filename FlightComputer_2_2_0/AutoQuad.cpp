...
void QuadController::updateMotorThrust() {
  ...
  double fl = 1000.0d + (this->thrust) - (*this->rollOutput) + (*this->pitchOutput) - (*this->yawOutput) + batteryScalar*(this->batteryAddedThrust);
  double fr = 1000.0d + (this->thrust) + (*this->rollOutput) + (*this->pitchOutput) + (*this->yawOutput) + batteryScalar*(this->batteryAddedThrust);
  double bl = 1000.0d + (this->thrust) - (*this->rollOutput) - (*this->pitchOutput) + (*this->yawOutput) + batteryScalar*(this->batteryAddedThrust);
  double br = 1000.0d + (this->thrust) + (*this->rollOutput) - (*this->pitchOutput) - (*this->yawOutput) + batteryScalar*(this->batteryAddedThrust);
